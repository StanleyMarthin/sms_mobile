...
Caller: TaskBloc saat submit execution dan modul job plan saat split jam kerja.
Dependensi: TaskExecutionLog, TimeParser, CountdownHelper.
Main Functions: splitOvertime, splitJobPlanItem.
...
class TaskExecutionHelper {
  ...
  static List<TaskExecutionLog> splitOvertime(TaskExecutionLog log) {
    ...
    final durationSplitDt = startDt.add(
      Duration(minutes: maxNormalWorkMins + log.breakDurationMinutes),
    );
